...
def load_data():
	...
	print(len(X_dev), 'development instances')
	# Test data
	X_test = []
	Y_test = []
...
if __name__ == '__main__':
	...
	# changed the default values of the epochs and batch size to 11 and 60 respectively
	parser.add_argument('-e', '--epochs', metavar='N', type=int, default=11, help='epochs')
	parser.add_argument('-bs', '--batch-size', metavar='N', type=int, default=60, help='batch size')
	...
	model = Sequential()
	# Single 5000-neuron hidden layer with relu activation
